# GTA SA for Hitmans' Agency (Текущая версия: 1.03)

**Как скачать:** кликайте на .rar архив (514 МБ), в разделе **Releases** справа ---------->
...
- sampfuncs-settings - Игра запускается в окне без рамки, не перекрывает остальные приложения
...
- MoonHUD.lua - Замена игрового интерфейса (**/hud** - настройки скрипта)
...
> Может конфликтовать при сворачивании игры в полноэкранном режиме на долгое время 
...
## По мелочи:
- Прозрачная карта для радара (Transparent Map)
- замена погодного цикла (timecyc)
