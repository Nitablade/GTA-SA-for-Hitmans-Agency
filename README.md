...
<sub>Настроено 3 из 5 доступных списков: Хитманы, Детективы, Чёрный список</sub>
<sub>**/cadd [номер списка] [ID]** - добавить игрока в указанный список (Пример: /cadd 1 123)</sub>
<sub>**/crem [номер списка] [ID]** - удалить игрока из указанного списка</sub>
