...
**Как скачать:** кликайте на .rar архив (999 МБ), в разделе **Releases** справа ---------->
...
- CardGameCheck.lua - Отображение столов в казино, за которыми идёт игра в дурака, от KyMbIc
> Скрипт модифицирован, убраны лишние слова в 3D-текстах, помимо активных столов также показывает статус остальных в радиусе 50 метров
...
- Contract_Position.lua - Помощь в обнаружении цели и прицеливании от KyMbIc (**/cpos** - включение/выключение скрипта)
